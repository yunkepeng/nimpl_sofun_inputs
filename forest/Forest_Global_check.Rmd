...
gg$gglegend
#analyse_modobs2(subset(NPP,wnf_obs_final>0 & pred_wnf>0 & pft2 == "Forest"),"pred_wnf","wnf_obs_final", type = "points")
...
gg$ggmap + geom_point(data=subset(NPP2,CN_leaf_final>0 & predicted_leafcn>0),aes(lon,lat),col="red") 
gg$gglegend
