...
for (i in c(1:377,379:608,611:626,629:632,635:756,759:length(forcing_df))){
...
# i = 378,609,610,627,628,633,634,757,758 are not available for fpar

#Some fapar sites' value are not available - may be due to in the edge and so the data was missing
for (i in c(378,609,610,627,628,633,634,757,758)){
  df1 <- read.csv(forcing_df[i])
  print(df1$sitename[1])
}
na_data <- subset(NPP_grassland2,sitename=="NPP1376"|sitename=="NPP1605"|sitename=="NPP1606"
                  |sitename=="NPP1623"|sitename=="NPP1624"|sitename=="NPP1629"|sitename=="NPP1630"
                  |sitename=="NPP436"|sitename=="NPP440")
na_data
