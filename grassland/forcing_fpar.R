...
NPP_forest <- subset(NPP_final,pft2=="Grassland")
...
fpar_list <- list.files("/Users/yunpeng/data/grassland_new/fpar_all",full.names = T)
length(fpar_list)-1

forcing_list <- list.files("/Users/yunpeng/data/grassland_new/forcing",full.names = T)
length(forcing_list)
