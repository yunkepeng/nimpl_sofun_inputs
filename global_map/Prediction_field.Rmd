...
soil <- raster('/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/soilCN/w001000.adf') # map input from the last 2015 version of ISRIC (Batjes 2015 ISRIC report)

Global_grid <- as.data.frame(read.csv(file="/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/soilCN/Global_cell.csv")) #Input global land grids (0.5 degree;N = 259200)
...
ISRIC.data<-read.csv(file="/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/soilCN/HW30s_FULL.csv",header=TRUE,sep=";",dec = ".") # Now, input ISRIC database
...
ncfname <- paste ("/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/age/", "GFAD_V1-1", ".nc", sep="")
...
library(ncdf4)
library(raster)
ncfname <- paste ("/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/fAPAR/", "fAPAR3g_v2_1982_2016_FILLED", ".nc", sep="")
dname <- "FAPAR_FILLED"
...
```{r}
library(raster)
alphalist <- list.files(path = "/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/alpha/",full.names = T) # here this file includes 116 data - that is the annual alpha from 1901 to 2016
...
ncfname <- paste ("/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/PPFD/", "PPFD", ".nc", sep="")
dname <- "PPFD"
ncin <- nc_open(ncfname)
...
ncfname <- paste ("/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/Tg/", "Tg", ".nc", sep="")
dname <- "Tg"
...
library(raster)
library(ncdf4)
ncfname <- paste ("/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/vpd/", "vpd", ".nc", sep="")
dname <- "vpd"
...
SLA_extracted <- read.csv(file="/cluster/work/climate/bestocke/data/nimpl_sofun_inputs/map/Original_data/LMA/SLA_export.csv") #This dataframe outputted from ArcGIS, including FID, lon, lat, Elevation, SLA (mg/mm)
