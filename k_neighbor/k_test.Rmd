...
#After this, this will be outputed as nc file in R, and then processed by CDO-processing in Euler (to make coordinates consistent), and finally saved in "~/data/nimpl_sofun_inputs/map/Final_ncfile/newLMA.nc" in order to update our prediction field in yunkebranch.
