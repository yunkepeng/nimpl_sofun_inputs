...
#NPP_SaraVicca <- read.csv(file="~/data/NPP_Yunke/NPP_ForC/orig/ForC_measurements_final.csv")
...
#4. Inputing exist sites, as this will be used to check repetation in the future
...
names(GNPP_final) <- c("sites.sitename","Begin_year","End_year","NPP_1_C","GPP_C","TBCF_C","NPP_2_C",
                       ...
                       "biomass_C","biomass_ag_OM","biomass_ag_C","biomass_ag_woody_C","biomass_ag_foliage_C",
                       "biomass_root_C","biomass_root_coarse_C","biomass_root_fine_C")
...
#8. we seethat some new sites still not have data, so we merged them twice. This time, we aggregate AND merge data only based on sites, rather than sites+measured year. This way will help us generate more available data.
