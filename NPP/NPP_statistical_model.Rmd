...
#The pre-processing code of Forc was available at "D:/PhD/nimpl_sofun_inputs/Data/NPP/NPP_ForC/NPP_Forc_preprocessing.Rmd" and also available in yunkepeng github: nimpl_sofun_input/NPP/NPP_Forc_preprocessing.Rmd.
...
#tmn <- read.csv(file="~/data/NPP_Yunke/climate/tmnlist3.csv")
#tmx <- read.csv(file="~/data/NPP_Yunke/climate/tmxlist3.csv")
#vap <- read.csv(file="~/data/NPP_Yunke/climate/vaplist3.csv")
#radi<- read.csv(file="~/data/NPP_Yunke/climate/radlist3.csv")
#alphalist3 <- read.csv(file="~/data/NPP_Yunke/climate/alphalist3.csv")
#CaGlobal <- read.csv(file="~/data/NPP_Yunke/climate/CaGlobal.csv")
#pre <- read.csv(file="~/data/NPP_Yunke/climate/prelist3.csv")

tmn <- read.csv(file="D:/PhD/nimpl_sofun_inputs/Data/climate/tmnlist3.csv")
tmx <- read.csv(file="D:/PhD/nimpl_sofun_inputs/Data/climate/tmxlist3.csv")
vap <- read.csv(file="D:/PhD/nimpl_sofun_inputs/Data/climate/vaplist3.csv")
radi<- read.csv(file="D:/PhD/nimpl_sofun_inputs/Data/climate/radlist3.csv")
alphalist3 <- read.csv(file="D:/PhD/nimpl_sofun_inputs/Data/climate/alphalist3.csv")
CaGlobal <- read.csv(file="D:/PhD/nimpl_sofun_inputs/Data/climate/CaGlobal.csv")
pre <- read.csv(file="D:/PhD/nimpl_sofun_inputs/Data/climate/prelist3.csv")
...
Tg_cal <- function(tmn,tmx){
  #-----------------------------------------------------------------------
  # Input:   ¦Ä (s;solar delclination), 12 month constant values
...
Tg <- Tg_cal(tmn,tmx) # monthly Tg in ¡æ
...
agee <- na.omit(manage_age[,3:4])
names(agee) <- c("site","age")
agee2 <- aggregate(age~site,data=agee,mean)
...
Evergreen2 <- Evergreen[,c(4:5)]

final_sites5 <- merge(final_sites4,Evergreen2,by=c("site"),all.x=TRUE)
summary(final_sites5)

####7. Output of analyses
######(1) NPP/GPP function
...
summary(lmer(log((TNPP_1/GPP)/(1-(TNPP_1/GPP)))~log(CN)+log(age)+alpha+observedfAPAR+(1|site),data=final_sites5))
