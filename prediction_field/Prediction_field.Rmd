...
d <- writeRaster(rage, paste0("D:/PhD/nimpl_sofun_inputs/Data/Final_ncfile/","age_0923_interpolated.nc"),
                 format = "CDF", overwrite = TRUE, varname = "age", 
                 varunit = "yrs", longname = "stand-age", 
                 xname = "lon", yname = "lat")
