...
# 422 rows = lon, lat, monthly data from 1982-2016, Now, select lat,lon and 1982-2011
...
alpha_input <- as.data.frame(cbind(lonlat,final_alpha)) #here we kept using lonlat from fAPAR analysis above...
...
vpd is vapor-pressure-deficient (kPa). We used the 30 yrs average data (1982-2011), which was originally derived from monthly data from CRU ts 4.01. See formula below:
